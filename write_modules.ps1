#encoding: utf-8
# PowerShell скрипт для записи VBA-модулей в кодировке Windows-1251
# ВАЖНО: этот файл должен быть сохранён в UTF-8 с BOM
...
# 1. Mod_Utils.bas
Write-File1251 "$basePath\Mod_Utils.bas" @(
    ...
    'End Function',
    '',
    "' Функция: получение имени текущего пользователя Windows",
    'Public Function GetCurrentUser() As String',
    '    GetCurrentUser = Environ("USERNAME")',
    'End Function',
    '',
    "' Функция: форматирование даты в строку SQLite (ГГГГ-ММ-ДД)",
...
Write-Host '1/6 Mod_Utils.bas written'