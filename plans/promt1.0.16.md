# Задание для SourceCraft `plans/promt1.0.16.md`

**!!!ВАЖНО: `.ycarules` имеет высший приоритет!!!**

## Цель

Версия проекта SysW — `1.0.16`

## Задачи

- вместе с юзером начинаем испытания бизнес логики, строить в режиме вопрос-ответ
...
```mermaid
3lowchart TD
    A[Ask: анализ promt1.0.16.0.md и текущего кода] --> B[Architect: план обновлений]
