...
| **Тестирование** | ✅ v0.2.0, актуализировано v1.0.15 | `Mod_FullTestRunner` — TC-01..TC-64 + TC-S1..TC-S3 (полный перечень — см. `docs/reestr.md`, раздел 3) |
...
- [ ] **G-REESTR** · глобальная (отложенная, v1.1.0) · независимая · условие: решение о способе интеграции (в DEVELOPER/архив) — интеграция `docs/reestr.md` в общую документацию с последующим удалением/переносом; вынесена из активного блока (промт 1.1.0 Задача 13)
