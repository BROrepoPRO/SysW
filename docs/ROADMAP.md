...
> **Версия системы:** 1.0.10
> **Дата:** 2026-08-21
> **Статус:** Актуализирован (v1.0.10: создан реестр макросов, скриптов и тестов `docs/reestr.md`; документация приведена к фактическому состоянию; состав листов `src/sheets/` = `Лист2/Лист3/Лист5/Лист9`; набор тестов TC-01..TC-50 + TC-S1..S3)
