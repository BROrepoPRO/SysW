...
> **Дата:** 2026-08-21
> **Статус:** Актуализирован (v1.0.8: устойчивость COM-этапов к зависаниям, ранний контроль компиляции VBA в конвейере, восстановлен тест TC-29, добавлен поиск/фильтрация на листах запчастей)

---

## 1. Текущее состояние

Система SysW (v1.0.8) — модульная VBA-надстройка для Excel с обвязкой на Python/PowerShell, автоматизирующая обработку заказ-нарядов авторемонта (импорт данных из отчётов, заполнение шапки заказа, поиск по ГРЗ, учёт работ и запчастей).
