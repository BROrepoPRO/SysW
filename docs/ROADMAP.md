...
- [ ] **K-02** · техдолг (производительность) · независимая · без условий — **`AutoMatchWorks`
  ...
  модельных артикулов).
- [ ] **K-03** · техдолг · независимая · без условий — **`AutoMatchWorks`/`AutoMatchParts`
  не подобрали артикулы**: пусто вместо «НЕ НАЙДЕНО», при том что модельные артикулы O/AB
  проставлены. Рекомендация: проверить отображение состояния «не найдено» в результатах
  автоподбора.
