...
Проект построен на модульной архитектуре VBA с разделением на 13 стандартных модулей (`.bas`), 2 класса (`.cls`) и 3 класса листов (`.cls`). Исходный код организован в директории `src/`:
